...
def Create_JSON(file_path, stats_df):
    ...
    for index, row in df.iterrows():
        ...
        # Fetch screen object mapping from Neo4j
        objectprompt ="\nSAP Object and Screen mapping  is as follows: "+ fetch_screen_object_mapping()
    ...
    #    objectprompt += f"""\nFor e.g. for VA01 TCode, screen sequence is as follows: SAPMV45A:0101, SAPMV45A:4701, SAPMV45A:4021, SAPMV45A:4900"""
